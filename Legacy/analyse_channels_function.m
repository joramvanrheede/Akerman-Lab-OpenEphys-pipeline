...
for a = 1:length(channels)
    ...
    for b = 1:cond_nr
        ...
        for c = 1:n_episodes
            ...
            whiskspikes         = thesespikes - conditions(b,2);
            prewhiskcounts(c,:) = histc(whiskspikes,prewhiskbins);
            whiskrates(c)       = sum(whiskspikes > whiskwin(1) & whiskspikes < whiskwin(2)) / (whiskwin(2) - whiskwin(1));
        end
        ...
        channels(a).conditions(b).whiskrates        = whiskrates;
        channels(a).conditions(b).prewhiskcounts    = prewhiskcounts;
        ...
        %%
        whiskraster     = rasterspikes - conditions(b,2);
