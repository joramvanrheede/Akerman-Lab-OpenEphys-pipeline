function [peak_rate_of_fire, peak_time] = peak_ROF_in_win(spikes,time_win,kernel_size,sample_rate)
% function [PEAK_RATE_OF_FIRE, PEAK_TIME] = peak_ROF_in_win(SPIKES,TIME_WIN,KERNEL_SIZE, SAMPLE_RATE)
% 
...
% 
% PEAK_RATE_OF_FIRE: estimated peak rate of fire in Hz.
% 
% PEAK_TIME: time of this peak, in seconds.
% 
% 
...
spike_rate_counts 	= histc(spikes(:)',spike_rate_bins(:)',2);
...
spike_rate_profile              = spike_rate_profile * sample_rate / n_trials / n_channels;

[peak_rate_of_fire, maxinds]    = max(spike_rate_profile);
