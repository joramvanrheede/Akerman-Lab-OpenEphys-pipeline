function [spike_rate, spike_rate_serr] = spike_rate_in_win(spikes, time_win)
% function [spike_rate, spike_rate_serr] = spike_rate_in_win(SPIKES, TIME_WIN)
% 
% Returns SPIKE_RATE in Hz in a given TIME_WIN. Spike rate is average 
% for all channels and all trials in SPIKES. Also returns SPIKE_RATE_SERR, 
% the standard error of the mean over trials.
% 
...
serr_spike_count                    = serr(spike_counts_by_trial);
...
spike_rate_serr     = serr_spike_count / delta_t;
