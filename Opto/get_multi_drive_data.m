function [multi_drive_data] = get_multi_drive_data(data_folder, resp_win, psth_bins)
...
for a = 1:length(expt_folders)
    ...
    for b = 1:length(this_exp_files)
        ...
        multi_drive_data(a).experiment(b)    = drive_multi_function(ephys_data, resp_win, psth_bins, 4);
