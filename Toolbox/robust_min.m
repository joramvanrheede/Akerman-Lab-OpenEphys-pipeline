function min_val    = robust_min(indata, percentile, dim)
% function min_val    = robust_min(indata, percentile, dim)
% 
% 
% Get the minimum of INDATA bar the top PERCENTILE % of data points.
...
% Alternatively, if DIM = 'all' it will give a single min value for all
% data points.
...
min_val         = min(trimmed_indata,[],dim);
